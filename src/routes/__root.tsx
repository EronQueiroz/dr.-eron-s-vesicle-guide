  ...
  "@graph": [
    {
      ...
      description:
        "Cirurgião do Aparelho Digestivo especializado em cirurgia de vesícula biliar em Brasília/DF. Atendimento na Clínica Lívere, Lago Sul.",
    ...
    },
    {
      ...
      address: {
        "@type": "PostalAddress",
        streetAddress: "St. de Habitações Individuais Sul, Ed. Santos Dumont Medical Center, Bloco B, Sala 010-7",
        addressLocality: "Brasília",
        addressRegion: "DF",
        postalCode: "71605-170",
        addressCountry: "BR",
      },
      geo: { "@type": "GeoCoordinates", latitude: -15.8356, longitude: -47.9298 },
  ...
  return (
    <html lang="pt-BR">
      ...
      <body>
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-M39BXWZ6"
            height="0"
            width="0"
